...
namespace Strict.Compiler.Tests
{
	public class LexerTest
	{
		...
		public void TestTokenizerFloatNumber(string doubleValue, TokenType expectedToken)
		{
			...
			AssertToken(lexer.NextToken(), new Token { Value = doubleValue, TokenType = expectedToken });
		}
		...
		public void TestTokenizerOperators(string @operator, TokenType expectedToken)
		{
			...
			AssertToken(lexer.NextToken(), new Token { Value = @operator, TokenType = expectedToken });
		}
		...
		public void TestEmptyLines()
		{
			...
			while (true)
			{
				...
				if (token == null)
					break;
				AssertToken(token, new Token { Value = "\r\n", TokenType = TokenType.EndOfLine });
			}
		}
