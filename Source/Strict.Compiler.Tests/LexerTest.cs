...
namespace Strict.Compiler.Tests
{
    public class LexerTest
    {
        ...
        public void TestTokenizerStrings(string str, TokenType expectedToken)
        {
            ...
            AssertToken(lexer.NextToken(), new Token { Value = str.Replace("\"", ""), TokenType = expectedToken });
        }
...
print i j k";
        ...
        energy to type more and more ...""""""";
            ...
            var lexer = new Lexer(source);
            AssertToken(lexer.NextToken(), new Token { Value = lexerExpectedValueResult, TokenType = TokenType.String });
        }
    }
}